...
std::unordered_map<std::string, std::string> Database_API::get_paths(const std::string &username) {
    sqlite3_stmt *query;
    // select
...
bool Database_API::save_paths(const std::unordered_map<std::string, std::string> &map, const std::string &username) {
    sqlite3_stmt *query;
    // delete
